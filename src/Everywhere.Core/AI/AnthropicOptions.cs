...
public sealed partial class AnthropicOptions : ObservableObject
{
    ...
    [SettingsItem(DocumentUrl = "https://platform.claude.com/docs/en/build-with-claude/extended-thinking")]
    ...
    [SettingsItem(DocumentUrl = "https://platform.claude.com/docs/en/build-with-claude/adaptive-thinking")]
    ...
    [SettingsItem(DocumentUrl = "https://platform.claude.com/docs/en/build-with-claude/prompt-caching")]
