...
|-----------------|---------------------|
| `VisualElementAttachment` | Element properties + Content |
| `TextSelectionAttachment` | Selected text content |
| `TextAttachment` | Text content |
| `FileAttachment` | File path, extension, MIME type |
...
#### 7.2.2 TextAttachment / TextSelectionAttachment
...
│   │   ├── VisualElementCondition.cs      # VisualElementAttachment
│   │   ├── TextCondition.cs               # TextAttachment/Selection
│   │   ├── FileCondition.cs               # FileAttachment
